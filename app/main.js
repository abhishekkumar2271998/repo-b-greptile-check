...
// Minimal .env loader (no external dependency). Reads key=value pairs from a
// .env file next to this script and populates process.env without overwriting
// values already present in the environment. Credentials are kept out of the
// source tree and out of git (.env is gitignored).
function loadDotEnv() {
